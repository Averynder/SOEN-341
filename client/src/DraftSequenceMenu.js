            ...
            <div style={{textAlign: "center"}}>
              <Form>
                <div className="form-group">
                  <label for="semester"><h5>Select Semester</h5></label>
                    <select id="semester" className="custom-select" value={this.state.semester} onChange={this.handleSemester}>
                      <option>Fall</option>
                ...
                <div className="form-group">
                  <label for="semester-year"><h5>Select Year</h5></label>
                    <select id="semester-year" className="custom-select" value={this.state.year} onChange={this.handleYear}>
                      {years}
                    </select>
                </div>
              </Form>
