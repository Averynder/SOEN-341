...
async.waterfall([task0,task1,task2,task3,task4,task5,task6,task7,task8,task9,task10,task11,task12,task13,task14], function() {
...
function task0(done) {
  ...
  // Niels Code here
	if (!(fs.existsSync('routes/SOENschedule.txt'))&& !(fs.existsSync('routes/COMPcatalog.txt')) && !(fs.existsSync('routes/COMPschedule.txt'))){
