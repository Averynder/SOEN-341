...
public class UserCase30 extends UC {
	static boolean run(){
		...
		action.dragAndDrop(courseToSwap, driver.findElement(By.cssSelector("div.tableCol:nth-child(2) > table:nth-child(1)")) ).build().perform();
	...
	//	System.out.println(driver.findElement(By.cssSelector("div.tableCol:nth-child(2) > table:nth-child(1) > tbody:nth-child(2)")).getText());
		...
		if (driver.findElement(By.cssSelector("div.tableCol:nth-child(2) > table:nth-child(1)")).getText().contains(courseToSwapContent)) {
